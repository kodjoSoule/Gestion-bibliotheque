	  				...
	  				<div class="panel-heading"><h3>Ajouter Livre</h3></div>
	  					...
	  					<?php
	  							...
	  							isset($_POST["submit"]))
	  						{
	  							...
	  							$bdd->exec("INSERT INTO livre (ISBN, TITRE_LIVRE, LANGUE_LIVRE, NBRE_EXPLAIRE_LIVRE) VALUES ($isbn, '$titre', '$langue', $exemplaire) ;INSERT INTO auteur ( NOM_AUTEUR, PRENOM_AUTEUR) VALUES ('$nomAu','$prenomAu');");
